...
export async function POST(request: Request) {
  try {
    ...
    return NextResponse.json(
      { error: "Failed to add new application with outreach." },
      { status: 500 }
    );
  }
}
...
export async function PUT(request: Request) {
  try {
    ...
    return NextResponse.json(
      { error: "Failed to update application with outreach." },
      { status: 500 }
    );
  }
}
...
export async function DELETE(request: Request) {
  try {
    ...
    return NextResponse.json({
      message: "Application with outreach deleted successfully",
    });
  } catch (error) {
    console.error("Error deleting application:", error);
    return NextResponse.json(
      { error: "Failed to delete application with outreach." },
      { status: 500 }
    );
  }
}
