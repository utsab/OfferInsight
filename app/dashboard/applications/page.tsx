...
type Application = {
  ...
  company: string;
  first_round_or_coding_challenge: boolean;
  final_round: boolean;
  offer: boolean;
};
  ...
  const columns = React.useMemo<ColumnDef<Application>[]>(
    () => [
      ...
      },
      {
        ...
        accessorKey: 'first_round_or_coding_challenge',
        footer: (props) => props.column.id,
      },
      {
        header: 'Final Round',
        accessorKey: 'final_round',
        footer: (props) => props.column.id,
      },
      {
        header: 'Offer',
    ...
    <div className="p-2">
      ...
      <div className="mt-4">
        ...
        <input
          type="number"
          placeholder="ID"
          value={newRow.application_id}
          onChange={(e) => setNewRow({ ...newRow, application_id: Number(e.target.value) })}
        ...
        <input
          type="checkbox"
          checked={newRow.first_round_or_coding_challenge}
          onChange={(e) => setNewRow({ ...newRow, first_round_or_coding_challenge: e.target.checked })}
        /> First Round/Coding Challenge
        <input
          type="checkbox"
          checked={newRow.final_round}
          onChange={(e) => setNewRow({ ...newRow, final_round: e.target.checked })}
        /> Final Round
        <input
          type="checkbox"
