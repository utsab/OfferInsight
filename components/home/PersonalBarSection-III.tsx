    ...
    >
      <div className="relative z-[2] h-full w-full overflow-hidden">
        {compactLayout ? (
          <div
            ref={refs.content}
            className="will-change-transform mx-auto flex w-full max-w-xl flex-col gap-5 px-4 pb-10 pt-14"
          >
            {/* Cinema coral band with soft top/bottom fades — cards sit above it */}
            <header className="relative z-0 px-5 pb-14 pt-6 text-left">
              <span
                data-personal-bar-measure-ignore
                className="pointer-events-none absolute -inset-x-3 -inset-y-16"
                style={{
                  background:
                    'linear-gradient(to bottom, rgba(15, 23, 42, 0), rgba(15, 23, 42, 0.14) 18%, rgba(15, 23, 42, 0.14) 82%, rgba(15, 23, 42, 0))',
                  filter: 'blur(10px)',
                }}
                aria-hidden
              />
              <span
                ...
                data-personal-bar-measure-ignore
                className="absolute -inset-x-1 -inset-y-16"
                style={{
              ...
              <div className="relative flex items-start justify-between gap-4">
                <div className="min-w-0">
                  ...
                  {title.subheading ? (
                    <p className="mt-1.5 text-xs font-bold uppercase tracking-widest text-white/85">
                      {title.subheading}
                    </p>
                  ) : null}
                </div>
                ...
                >
                  <img
                    src={logoPath}
                    alt={logoAlt}
                    className="max-h-10 w-auto max-w-full object-contain [filter:invert(1)_brightness(2)]"
                  />
                </div>
              </div>
            </header>
              ...
              {criteria.map((criterion, index) => {
                ...
                return (
                  <article
                    ...
                    className="rounded-xl border border-light-steel-blue/40 bg-white shadow-[6px_0_18px_rgba(15,23,42,0.09)]"
                  >
                    <div className="border-b border-light-steel-blue/35 p-4">
                      <span
          ...
          >
            <aside className="relative z-20 p-6 text-right shadow-[6px_0_20px_rgba(15,23,42,0.15)] sm:p-8 lg:p-10">
              <span
                data-personal-bar-measure-ignore
