export const HOME_ASSETS = {
  ...
  affiliations: [
    { path: '/images/home/adobe--eps--vector-logo.png', label: 'Adobe', scale: 3 },
    ...
    { path: '/images/home/micron-technology-logo.png', label: 'Micron', scale: 3 },
    { path: '/images/home/microsoft-logo_brandlogos.net_y0fjb.png', label: 'Microsoft', scale: 3 },
