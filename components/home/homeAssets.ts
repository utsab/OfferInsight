export const HOME_ASSETS = {
  ...
  affiliations: [
    ...
    { path: '/images/home/microsoft-logo_brandlogos.net_y0fjb.png', label: 'Microsoft', scale: 4.5 },
    { path: '/images/home/motorola-brandlogo.net.png', label: 'Motorola', scale: 4.5 },
