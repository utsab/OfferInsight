...
function CriterionDetail({ detail }: { detail: PersonalBarCriterion['detail'] }) {
  const detailClass =
    'text-left text-base leading-relaxed text-gray-200 sm:text-lg md:text-xl lg:text-2xl';
...
export function PersonalBarSection({
  ...
  return (
    <section
      ref={refs.section}
      id={sectionId}
      className={`${sectionShell} ${zIndexClass} overflow-hidden bg-gradient-to-br from-midnight-blue to-gray-900 opacity-0`}
