...
export function Navbar() {
  return (
    <nav
      id="site-navbar"
      className="fixed top-0 left-0 right-0 z-[110] border-b border-light-steel-blue bg-gradient-to-br from-midnight-blue to-gray-900 w-full"
    >
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 flex justify-between items-center gap-4">
